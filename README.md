...
```bash
$ git clone https://github.com/revou-fundamental-course/20-jan-25-FaizFatahilah123.git
```
2. Setelah proses cloning selesai, masuk ke dalam direktori proyek
```bash
$ cd 20-jan-25-FaizFatahilah123
```
3. Buka file index.html dengan peramban web untuk menggunakan kalkulator BMI.

Create with ♥ by <a href="https://github.com/FaizFatahilah123/">FaizFatahilah123</a>
